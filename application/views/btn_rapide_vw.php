   ...
   <?php foreach ($btn_tdb as $key => $value) {?>
        ...
        <div class="btn_std <?php echo $value['couleur']; ?> button">
            ...
            <div class="content_std" >
                    ...
                    <div class="bouttons">
                        <button class="btn-success btn-lg btn_appareil" type="button" typebtn="On" idbtn="<?php echo $value['idbtn']; ?>">On</button><br><br>
                        <button class="btn-danger btn-lg btn_appareil" type="button" typebtn="Off" idbtn="<?php echo $value['idbtn']; ?>">Off</button>
                    </div>
                </div>
